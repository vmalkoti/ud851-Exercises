...
public class MainActivity extends AppCompatActivity {
    ...
    private ProgressBar mLoadContentProgress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoadContentProgress = (ProgressBar) findViewById(R.id.pb_load_content);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPreExecute() {
            mLoadContentProgress.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            mLoadContentProgress.setVisibility(View.INVISIBLE);

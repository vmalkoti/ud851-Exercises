...
//  DONE (10) Add constant values to sync Sunshine every 3 - 4 hours
    public static final int SYNC_TIME_SECONDS = (int) TimeUnit.HOURS.toSeconds(3);
    public static final int FLEX_TIME_SECONDS = SYNC_TIME_SECONDS/3;
...
//  DONE (12) Create a method to schedule our periodic weather sync
    private static void scheduleWeatherSync(Context context) {
        ...
        Job syncJob = jobDispatcher.newJobBuilder()
                ...
                .setTrigger(Trigger.executionWindow(SYNC_TIME_SECONDS, SYNC_TIME_SECONDS+FLEX_TIME_SECONDS))

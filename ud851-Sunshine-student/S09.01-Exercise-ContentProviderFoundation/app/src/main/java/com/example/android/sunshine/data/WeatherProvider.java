...
//  DONE (5) Create static constant integer values named CODE_WEATHER & CODE_WEATHER_WITH_DATE to identify the URIs this ContentProvider can handle
    private static final int CODE_WEATHER = 500;
    private static final int CODE_WEATHER_WITH_DATE = 501;
...
//      DONE (9) Handle queries on both the weather and weather with date URI
        ...
        switch (match) {
            ...
            case CODE_WEATHER_WITH_DATE:
                ...
                String[] values = new String[] {weatherDate};
                returnCursor = db.query(WeatherContract.WeatherEntry.TABLE_NAME,
                        projection,
                ...
                break;
            default:
                throw new UnsupportedOperationException("Not implemented in query");
        }

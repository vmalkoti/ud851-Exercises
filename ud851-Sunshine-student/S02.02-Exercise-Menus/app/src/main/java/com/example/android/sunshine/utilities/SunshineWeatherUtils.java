...
public final class SunshineWeatherUtils {
    ...
    /**
     * Helper method to provide the icon forecast id according to the weather condition id returned
     * by the OpenWeatherMap call.
     *
     * @param weatherId from OpenWeatherMap API response
     *
     * @return forecast id for the corresponding icon. -1 if no relation is found.
     */
    ...
    /**
     * Helper method to provide the art forecast id according to the weather condition id returned
     * by the OpenWeatherMap call.
     *
     * @param weatherId from OpenWeatherMap API response
     *

...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logAndAppend("MainActivity.onCreate");
    }
    ...
    protected void onStart() {
        super.onStart();
        logAndAppend("MainActivity.onStart");
    }
    ...
    protected void onPostResume() {
        super.onPostResume();
        logAndAppend("MainActivity.onResume");
    }
    ...
    protected void onRestart() {
        super.onRestart();
        logAndAppend("MainActivity.onRestart");
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        logAndAppend("MainActivity.onDestroy");
    }

...
public class MainActivity extends AppCompatActivity {
    ...
    private String LIFEYCLE_CALLBACKS_TEXT_KEY = "callback";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            if(savedInstanceState.containsKey(LIFEYCLE_CALLBACKS_TEXT_KEY)) {
                // mLifecycleDisplay.setText(savedInstanceState.getString(LIFEYCLE_CALLBACKS_TEXT_KEY));
                mLifecycleDisplay.setText(savedInstanceState.getCharSequence(LIFEYCLE_CALLBACKS_TEXT_KEY));
            }
        }
    ...
    protected void onStop() {
        ...
        Log.d("DebuggingOnSave", "in onStop, getText()="
                + + System.identityHashCode(mLifecycleDisplay.getText()));
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        // outState.putString(LIFEYCLE_CALLBACKS_TEXT_KEY, mLifecycleDisplay.getText().toString());
        outState.putCharSequence(LIFEYCLE_CALLBACKS_TEXT_KEY, mLifecycleDisplay.getText());

        Log.d("DebuggingOnSave", "charSeq class" + outState.getCharSequence(LIFEYCLE_CALLBACKS_TEXT_KEY).getClass());
        Log.d("DebuggingOnSave", "TextViewCSObjID=" + System.identityHashCode(mLifecycleDisplay.getText()));
        Log.d("DebuggingOnSave", "BundleCSObjID=" + System.identityHashCode(outState.getCharSequence(LIFEYCLE_CALLBACKS_TEXT_KEY)));
        Log.d("DebuggingOnSave", "bundle==textview : "
                + (outState.getCharSequence(LIFEYCLE_CALLBACKS_TEXT_KEY)==mLifecycleDisplay.getText()));

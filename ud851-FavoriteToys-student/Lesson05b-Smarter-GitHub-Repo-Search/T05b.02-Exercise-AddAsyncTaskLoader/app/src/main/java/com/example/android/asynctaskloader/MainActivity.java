...
public class MainActivity extends AppCompatActivity
    ...
    private final int GITHUB_SEARCH_LOADER = 107;
    ...
    private void makeGithubSearchQuery() {
        ...
        if(githubQuery==null || TextUtils.isEmpty(githubQuery)) return;
    ...
    public android.support.v4.content.Loader<String> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String>(this) {
            ...
            public String loadInBackground() {
                Log.d("MainActivityBackground", "Starting loadInBackGround");
                String searchUrl = args.getString(SEARCH_QUERY_URL_EXTRA);
                if(searchUrl == null || TextUtils.isEmpty(searchUrl)) return null;
                try {

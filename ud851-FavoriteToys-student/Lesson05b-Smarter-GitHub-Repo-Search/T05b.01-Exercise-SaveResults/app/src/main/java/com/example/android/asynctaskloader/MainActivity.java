...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String GITHUB_QUERY_URL = "query_url";
    // DONE (2) Create a static final key to store the search's raw JSON
    private static final String GITHUB_RAW_JSON = "raw_json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            String savedUrl = savedInstanceState.getString(GITHUB_QUERY_URL);
            String savedJson = savedInstanceState.getString(GITHUB_RAW_JSON);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(GITHUB_QUERY_URL, queryUrl);
        ...
        outState.putString(GITHUB_RAW_JSON, rawJson);
    }

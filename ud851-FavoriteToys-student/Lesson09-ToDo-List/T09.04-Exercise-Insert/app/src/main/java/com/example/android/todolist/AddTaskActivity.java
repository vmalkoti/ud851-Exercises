...
public class AddTaskActivity extends AppCompatActivity {
    ...
    public void onClickAddTask(View view) {
        ...
        if(TextUtils.isEmpty(taskDescription)) return;
        ...
        provider.onCreate();
        Uri uri = provider.insert(TaskContract.TaskEntry.CONTENT_URI, values);

        // DONE (8) Display the URI that's returned with a Toast
        // [Hint] Don't forget to call finish() to return to MainActivity after this insert is complete
        Toast.makeText(getBaseContext(), "Task added " + uri.toString(), Toast.LENGTH_SHORT).show();
        finish();

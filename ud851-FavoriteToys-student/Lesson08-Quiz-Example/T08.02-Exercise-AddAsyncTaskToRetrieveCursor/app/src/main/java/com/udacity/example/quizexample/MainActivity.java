...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ContenProviderAsyncTask().execute();
    }
    ...
    private class ContenProviderAsyncTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            mData = cursor;
            if(cursor != null) {
                Log.i("AsyncTask", "Data returned by query " + cursor.getCount());
            } else {
                Log.i("AsyncTask", "Null cursor");
            }
        }
    }
}
